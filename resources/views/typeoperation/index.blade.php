...
@section('content')
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="card-box">
                ...
                <div id="custom-modal" class="modal-demo">
                    ...
                    <h4 class="custom-modal-title">Enregistrer un type d'opération</h4>
                    <div class="custom-modal-text text-left">
                        <form method="post" action="/type_operation">
                            @include('typeoperation.form', ['btnSubmit' => 'Enregistrer'])
                        </form>
                    </div>
                </div>

                <h4 class="text-dark header-title m-t-0">Liste des types d'opération</h4>
                <hr>
    ...
    @else
        <div class="text-center text-muted">
            <strong>Aucun type d'opération enregistrée</strong><br>
